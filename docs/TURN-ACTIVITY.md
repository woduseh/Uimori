...
> 2026-09-08 후속: [UI 설계 v2](UI-DESIGN-V2.md)는 이 접이식 패널을 장면 헤더의 상태 표시와 "작업 상세" 시트로 바꾸는 것을 제안해요. 아래의 응답별 독립·기본 접힘·펼침 보존·펼치기만으로 호출 없음 계약은 시트가 그대로 이어받아요. 구현 전까지는 아래 현행 동작이 유효해요.
