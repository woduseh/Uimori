...
> 2026-09-10 현재 상태 정정: 사용자 확인으로 Oracle에는 이미 schema v15가 배포되어 있어요. 아래는 2026-09-09의 v14 배포 절차와 당시 스크립트 계약을 설명하는 기록이에요. v14 전용 사전 검사나 초기화 명령을 현재 v15 서버에 그대로 적용하지 않아요. 이번 후속 작업에서는 서버 배포·초기화를 수행하지 않았어요.
