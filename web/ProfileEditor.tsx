...
export function ProfileEditor({ profile, library, onSaved, onError, onDirtyChange, onLibraryChanged, initialTab = 'characters', branchId, ownerBotId }: { ownerBotId?:string; branchId?: string; profile: ChatProfile; library: Library; onSaved: () => Promise<void>; onError: (error: string) => void; onDirtyChange?: (dirty: boolean) => void; onLibraryChanged?: () => Promise<void>; initialTab?: ProfileSection }) {
