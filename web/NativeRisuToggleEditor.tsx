...
export function NativeRisuToggleEditor({
  ...
  return (
    <section className="native-toggle-editor" aria-label="토글 정의 편집기">
      <div className="native-toggle-raw">
        <label>
          토글 정의 원문
          <textarea
            aria-label="토글 정의 원문"
        ...
        <p className="muted">한 줄에 한 항목을 입력해요.</p>
        {pending && (
          <p className="muted">
            적용하지 않은 원문이 있어요. 원문을 적용하면 GUI 편집을 계속할 수 있어요.
          </p>
        )}
      ...
      <details className="native-toggle-gui">
        <summary>GUI 편집기</summary>
              ...
              if (!item)
                return (
                  <div className="native-toggle-form">
                    <p className="muted">이 줄은 위 원문 편집에서 수정할 수 있어요.</p>
                  ...
                  {item.type === 'select' && (
                    <label>
                      ...
                      <small className="muted">
                        순서와 빈 선택지를 그대로 유지해요. 채팅 값은 0부터 시작하는 선택지
                        번호예요.
                      </small>
                    </label>
                  )}
