...
export function Dialog({ open, title, onClose, children, wide = false, className = '', scopeKey = '', role = 'dialog' }: { open: boolean; title: string; onClose: () => void; children: ReactNode; wide?: boolean; className?: string; scopeKey?:string; role?: 'dialog' | 'alertdialog' }) {
