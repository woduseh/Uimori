...
function bundle(kind: 'state' | 'memory' = 'state', endpoint?: string, text = 'Mira spent three coins at the harbor.') {
  ...
  const story: StorySnapshot = {
    ...
    models: endpoint ? { [kind]: { id: 'selected', revision: 1, title: 'Synthetic', connectionId: 'conn', modelId: `fixture-${kind}-selected`, maxOutputTokens: 2048, temperature: null, connection: { id: 'conn', revision: 1, title: 'Fixture', enabled: true, protocol: 'fixture-sse-v1', endpoint, catalog: [], catalogError: null } } } : {},
  };
