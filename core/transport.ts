...
export type ProviderToolCall = { id: string; name: string; arguments: Record<string, Json> };
...
export type WireRecord = {
  ...
  method: 'POST'; url: string; headers: Record<string, string>; body: Json; bodySha256: string; stablePrefixSha256: string;
};
