...
export type ChatProfile = { loreContext?: import('./lore-context.js').LoreContextPolicy; hiddenStory?: import('./hidden-story-package.js').HiddenStorySelection; chatId: string; revision: number; attachments: ContentRef[]; creative: CreativeControls; routes: Record<TaskRole, ContentRef | null>; image: boolean; prompts?: Partial<Record<PromptRole,ContentRef | null>>; promptControls?: Record<string,import('./prompt-program.js').ChatPromptControls>; packageAttachments?: import('./content-package.js').PackageAttachment[]; packageValues?: Record<string,Record<string,import('./prompt-program.js').PromptValue>> };
