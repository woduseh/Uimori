...
- 제품 코드 commit: d0b47cf18346567b36798fa7cc0e760d58e2f696. 이후 인수인계 commit은 문서/ACCEPTANCE 실행 결과만 바꿔요. 코드/build: bb367129c575cd92c505b72d277ac29660460a301a63e3d5ac3ba247a2eb0640.
...
- F01 추가 완료: 같은 commit의 두 clean 작업트리에서 별도 npm ci --offline, 동시 port55089/55091·DB/profile/temp 분리·각 source1 재열기 PASS. 증거: output/playwright/worktrees-2026-09-06T11-43-42-817Z-7dcc0fa7/summary.json. clean checkout의 동일 M0 verify도 PASS이며 output/playwright/clean-checkout-2026-09-06T11-43-17-360Z-38d62924에 보존했어요.
- 실행: npm ci → npm run doctor → npm run dev → http://127.0.0.1:4310. 검사: npm run verify -- --milestone M0. 정리: npm run cleanup -- --run <run-id>. 실제 dev ready/HTML200/Ctrl+C 종료까지 확인했어요.
- 정리: 검증·데모 서버와 전용 DB/temp/profile, 생성한 두 작업트리를 정리했어요. 보고서/화면/SQLite 백업은 output/playwright에 남겼어요. 실제 사용자 데이터는 사용하지 않았어요.
- 상태: **M0 완료**. 남은 M0 작업/승인 대기 없음. M1은 새 요청 전까지 시작하지 않아요. F01–F06의 실제 관찰·명령·증거와 한계는 [M0-RESULTS.md](M0-RESULTS.md), 짧은 사용법은 [root README](../README.md)에 있어요.
