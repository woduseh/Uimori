...
- M1 기능 검증 기준(이름 변경 전): 로컬 branch `codex/m1-local`; source/build ID `48e7f8e9fa3c13129c1775427996ff64f4c6d6bc22a6de7bea40e4b85d15185f`. dist SHA-256 `46a6d46866c08c22280d62c7d86da6089fb11be426a0924a2f27f0d81eb8bda3`. 아래 이름 변경은 별도 타입 검사와 빌드로 확인했어요.
...
- 정리: 검증 전용 서버·브라우저·runtime/temp는 종료·정리했고 reporter/화면/SQLite 증거는 각 output에 보존했어요. 사용자 서버를 종료하지 않았어요.
...
- 프로젝트 이름 확정: Uimori, npm package "uimori". 사용자 지정 원격 [woduseh/Uimori](https://github.com/woduseh/Uimori)의 main으로 초기 게시해요. 로컬 디렉터리는 ui-ai를 유지해요. 이름 변경 후 npm run check / npm run build PASS; build ID 45c815118c41c8be21f58f14f3f632a327fdd8ebc25b0507fc2b931c7b6c1fdb. 기능 변경은 없으며 전체 M1 검사는 재실행하지 않았어요.
