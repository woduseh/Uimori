...
const app = await createApp({ dbPath, buildId, instanceId, ...access, webRoot: resolve('dist/web'),approvedOrigins,liveBudget,vertexRequestTier:parseVertexRequestTier(process.env.NR_VERTEX_REQUEST_TIER),codex });
let closing = false;
