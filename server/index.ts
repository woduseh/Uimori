...
const app = await createApp({ dbPath, buildId, instanceId, testMode: process.env.NR_TEST_MODE === '1', webRoot: resolve('dist/web'),approvedOrigins,accessToken:process.env.NR_ACCESS_TOKEN });
let closing = false;
